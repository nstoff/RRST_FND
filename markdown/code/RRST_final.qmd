...
sdq_lm <- lm(formula = sdq ~  rrst_sensitivity + sex + group + anx_dep_SUM,
                 data = df) 
summary(sdq_lm)  # RRST sensitivity and GROUP and ANX_DEP ; meaning this assocaition is not due to the differences in affective symptoms 
...
```
### 3.2.3 ) Symptom Scores (FND only) - no sig
```{r}
#| warning: FALSE
#| error: FALSE
